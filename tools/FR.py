import sys, threading, random, urllib2
...
def buildblock(size):
	...
	for i in range(0, size):
		a = random.randint(55, 190)
		out_str += chr(a)
	return(out_str)

def usage():
	print ''
	print 'USAGE: python FR.py https://www.examplesite.com'
	print 'you can add "safe" after url, to autoshut the tool'
	print ''
